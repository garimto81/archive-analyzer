...
**Version**: 4.1.0 | **Updated**: 2025-12-06 | **Context**: Windows 10/11, PowerShell, Root: `D:\AI\claude01`
...
- [ ] 근본 원인을 이해했는가?
- [ ] 전체 코드베이스에서 유사 패턴을 검색했는가? (`grep -r`)
- [ ] 이 수정이 다른 곳에 영향을 주는가?
- [ ] 재발 방지책이 포함되어 있는가?

**금지**: 증상만 보고 즉시 수정, 단일 파일만 수정, "일단 되게 하자"
